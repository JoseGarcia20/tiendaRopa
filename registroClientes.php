      ...
      <div class="main-header__container">
        ...
        <main id="main" class="d-flex justify-content-center flex-column align-items-center p-3 m-3">
            ...
            <form class="d-flex flex-column p-1 g-3 needs-validation m-3">
              ...
              <div id="main-header__title" class="p-4 d-flex justify-content-center align-items-center" ><H1>Registro clientes</H1></div>
              ...
              <div class="mb-3">
                  <label for="experiencia" class="form-label" >¿Algún estilo en especial que te guste? Cuentanos...</label>
