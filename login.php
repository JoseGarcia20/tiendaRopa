    ...
    <header class="main-header">
      ...
      <main id="main" class="d-flex justify-content-center flex-column align-items-center p-3 m-3">
        ...
        <form class="d-flex flex-column p-1 g-3 needs-validation m-3">
          ...
          <div id="main-header__title" class="p-4 d-flex justify-content-center align-items-center" ><H1>Login</H1></div>
    
          <div class="formulario">
          <div class="mb-3 form-floating">
              <input type="text" class="form-control" id="email" name="email" placeholder="User05">
              <label for="correo" class="form-label p-3">Usuario: </label>
          </div>
        ...
        <div id="registros">
          ...
          <div class="d-flex mb-3">
              <input type="submit" class="form-control btn-outline-dark me-4" id="enviarDatos" name="enviarDatos" value="Ingresar...">
